...
namespace FiveNightsAtGorillas.Managers.Sandbox
{
    public class SandboxValues : MonoBehaviour
    {
        ...
        public void SwitchValue(string value)
        {
            ...
            {
                if (ShorterNight) { ShorterNight = false; RefrenceManager.Data.ShorterNightOn.text = "False"; RefrenceManager.Data.ShorterNightOn.color = Color.red; } else { ShorterNight = true; RefrenceManager.Data.ShorterNightOn.text = "True"; RefrenceManager.Data.InfinitePowerOn.color = Color.green; }
                return;
            }
