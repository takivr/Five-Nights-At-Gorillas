...
namespace FiveNightsAtGorillas.Managers.AI
{
    public class AIManager : MonoBehaviourPunCallbacks
    {
        ...
        public static AIManager Data;

        void Awake() 
        { 
            Data = this; PhotonNetwork.AddCallbackTarget(this); PhotonNetwork.NetworkingClient.EventReceived += OnEvent;
            if(AIName == "gorilla") { CamPos = "Cam11"; }
            if(AIName == "mingus") { CamPos = "Cam11"; }
            if(AIName == "bob") { CamPos = "Cam11"; }
            if(AIName == "dingus") { CamPos = "Stage1"; }
        }
        ...
        IEnumerator GorillaLocalDelay()
        {
            ...
            if (CamPos == "Cam11") { MoveGorilla("Cam10"); }
            else if (CamPos == "Cam10") { int random = Random.Range(0, 2); if (random == 1) { MoveGorilla("Cam5"); } else { MoveGorilla("Cam4"); } }
            else if (CamPos == "Cam4") { int random = Random.Range(0, 2); if (random == 1) { MoveGorilla("Cam3"); } else { MoveGorilla("Cam10"); } }
            else if (CamPos == "Cam5") { MoveGorilla("Cam10"); }
            else if (CamPos == "Cam3") { if (DoorManager.Data.RightDoorOpen) { FNAG.Data.Jumpscare(); } }
        }
        ...
        IEnumerator MingusLocalDelay()
        {
            ...
            if (CamPos == "Cam11") { MoveMingus("Cam10"); }
            else if (CamPos == "Cam10") { int random = Random.Range(0, 2); if (random == 1) { MoveMingus("Cam9"); } else { MoveMingus("Cam1"); } }
            else if (CamPos == "Cam7") { MoveMingus("Cam1"); }
            else if (CamPos == "Cam9") { MoveMingus("Cam10"); }
            else if (CamPos == "Cam1") { int random = Random.Range(0, 2); if (random == 1) { MoveMingus("Cam7"); } else { MoveMingus("Cam2"); } }
            else if (CamPos == "Cam2") { int random = Random.Range(0, 2); if (DoorManager.Data.LeftDoorOpen) { FNAG.Data.Jumpscare(); } }
        }
        ...
        IEnumerator BobLocalDelay()
        {
            ...
            if (CamPos == "Cam11") { MoveBob("Cam10"); }
            else if (CamPos == "Cam10") { int random = Random.Range(0, 2); if (random == 1) { MoveBob("Cam6"); } else { MoveBob("Cam4"); } }
            else if (CamPos == "Cam6") { MoveBob("Cam10"); }
            else if (CamPos == "Cam4") { MoveBob("Cam3"); }
            else if (CamPos == "Cam3") { int random = Random.Range(0, 2); if (DoorManager.Data.RightDoorOpen) { FNAG.Data.Jumpscare(); } }
        }
        ...
        IEnumerator DingusLocalDelay()
        {
            ...
            if (CamPos == "Stage1") { MoveDingus("Stage2"); }
            if (CamPos == "Stage2") { MoveDingus("Stage3"); }
            if (CamPos == "Stage3") { MoveDingus("Stage4"); }
            if (CamPos == "Stage4") { MoveDingus("Stage5"); }
            if (CamPos == "Stage5") { MoveDingus("Stage6"); }
        ...
        void OnEvent(EventData photonEvent)
        {
            ...
            switch (photonEvent.Code)
            {
                ...
                case (byte)PhotonData.Key.Mingus:
                    ...
                    else if (CamPos == "Cam2") { if (DoorManager.Data.LeftDoorOpen) { FNAG.Data.Jumpscare(); } }
                    break;
            ...
            if (AllowedToRun)
            {
                ...
                foreach (AIManager ai in AI)
                {
                    if (ai.AIName == "dingus")
                    {
                        ...
                        if (NewCamPos == "Stage2") { RefrenceManager.Data.dingus[1].SetActive(true); }
                        if (NewCamPos == "Stage3") { RefrenceManager.Data.dingus[2].SetActive(true); }
                        if (NewCamPos == "Stage4") { RefrenceManager.Data.dingus[3].SetActive(true); }
                        if (NewCamPos == "Stage5") { RefrenceManager.Data.dingus[4].SetActive(true); }
