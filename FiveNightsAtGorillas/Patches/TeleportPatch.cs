//teleport code stolen from: https://github.com/GermanEmpire0/Portal-Gun/blob/main/Patches/TeleportPatch.cs and that code was stolen from: https://github.com/KyleTheScientist/Bark/blob/master/Patches/TeleportPatches.cs 
//I am very evil >:)
...
namespace FiveNightsAtGorillas.Patches.Teleport
{
    ...
    internal class TeleportPatch
    {
        ...
        internal static void TeleportPlayer(Vector3 destinationPosition, float destinationRotation, bool killVelocity)
        {
            if (_isTeleporting)
                return;
